...
$query_coduser_finaliza = pg_query("select coduser from inscricao_pos_finaliza where edital='$edital_atual' and coduser <> '110' and coduser <> '592' and coduser <> '210'and coduser <> '618' ");
...
//$j = $i +1;
		...
		if ($programa == 'Verao') $programa = 'Verão';
		//echo $programa;
		//if ($programa == "Verão"){
		echo "Inscrição: ".$j;
		$j++;
